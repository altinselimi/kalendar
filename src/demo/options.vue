  ...
  <div class="options-wrapper">
    <div class="preferences-wrapper"
      ...
      <div class="pref-slot">
        ...
        <label>Hidden days
          <el-select v-model="calendar_settings.hide_days"
                     placeholder="Select one or more"
                     multiple
                     size="small">
            <el-option :value="option.value" :label="option.label" :key="option.value" v-for="option in days"></el-option>
          </el-select>
        </label>
        <label>Hidden dates
          <el-select v-model="calendar_settings.hide_dates"
                     placeholder="Select one or more"
                     multiple
                     size="small">
            <el-option :value="option.value" :label="option.label" :key="option.value" v-for="option in dates"></el-option>
          </el-select>
        </label>
        <label>Scroll to now
